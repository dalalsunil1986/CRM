...
public class Customer_details_Page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/crm/Update.png"))); // NOI18N
...
class customer_details_table extends javax.swing.JFrame {
    ...
    public customer_details_table() {
        ...
        try
        {
            Customer_details_Page demo = new Customer_details_Page(); //getting information from the page.
            ...
            String sql = "SELECT * FROM productssold WHERE Cust_name='"+demo.name+"' AND date='"+demo.date+"';"; //retriving data
        ...
        {
            JOptionPane.showMessageDialog(this,"Error in connectivity" ); //error when data incorrect.
        }      
    }
}
