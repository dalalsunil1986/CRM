...
public class Sell_Product extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/crm/save.png"))); // NOI18N
...
// retriving data :            
        String query1 = "SELECT Product_by_Count FROM products_info WHERE product_ID='"+id +"' AND Product_Name='"+Prod_nm +"';";
        ...
        while (rs1.next())
        {
            int count = rs1.getInt("Product_by_Count");
            if (count <= 0)
            {
        ...
        if (flag == 1)
        {
            ...
            String query = "INSERT INTO crm_db.productssold (Cust_name,Product_id,warranty,product_name,date)VALUES(" + "\"" + nm + "\"" + "," + id + "," + warr + "," + "\""+Prod_nm+"\"" + "," + "\"" + currentTime+"\"" + ");";
            System.out.println("Query :" + query);
            Statement st = con.createStatement();
            int val = st.executeUpdate(query);
            
            String query2 = "UPDATE products_info SET Product_by_Count = Product_by_Count - 1 WHERE product_ID = '"+id +"';";
    ...
    private void jMenu3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu3MouseClicked
        ...
        this.dispose();
        Home_Page frame = new Home_Page(); //module of home page 
    ...
    private void jMenu4MenuKeyPressed(javax.swing.event.MenuKeyEvent evt) {//GEN-FIRST:event_jMenu4MenuKeyPressed
        ...
        this.setVisible(false);
        this.dispose();
        Sell_Product frame = new Sell_Product(); //module of sell page
        frame.setDefaultCloseOperation( EXIT_ON_CLOSE );
        frame.pack();
        frame.setVisible(true);
    ...
    private void jMenu5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu5MouseClicked
        // TODO add your handling code here:
        Product_details_Page frame = new Product_details_Page(); //module of product details page
        frame.pack();
        frame.setVisible(true);
    ...
    private void jMenu6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu6MouseClicked
        ...
        this.setVisible(false);
        this.dispose();
        Customer_details_Page frame = new Customer_details_Page();
        frame.setDefaultCloseOperation( EXIT_ON_CLOSE );
        frame.pack();
        frame.setVisible(true);
